...
<head>
    ...
    <!--css-->
    <link rel="stylesheet" type="text/css" href="assets/css/talent-verification.css">
    </link>
...
<body>
                    ...
                    <div class="id-container">
                        <div style="flex-basis: 50%;text-align: left;">
                            <div style="overflow:hidden; border: 1px solid #c3c3c3; width: 97%;height: 280px;margin-bottom:10px">
                                <img alt="" id="front-id" style="width: 100%;height:100%">
                            </div>
                        ...
                        <div style="flex-basis: 50%;text-align: left;">
                            <div style="overflow:hidden; border: 1px solid #c3c3c3; width: 97%;height: 280px;margin-bottom:10px">
                                <img alt="" id="backed-id" style="width: 100%;height:100%">
                            </div>
    ...
    <div class="modal-message" id="modal-message" style="display:none;">
        <div class="modal">
            ...
            <p style="font-size: 18px;margin: 10px;color:#333">Now upload a photo that you are holding this id.</p>
                <div style="overflow:hidden; border: 1px solid #c3c3c3; width: 97%;height: 280px;margin-bottom:10px">
                    <img alt="" id="whole-id" style="width: 100%;height:100%">
                </div>
    ...
    <div class="modal-message" id="modal-message">
        <div class="modal">
            ...
            <div style="text-align: center; padding: 0 20px;">
                <p style="font-size: 18px;margin-top: 10px;color:#333">Now post a photo that you are holding this id.</p><br />
                 <input id="input-code" type="text" placeholder="">
    <p style="font-size: 16px;">Kindly wait for the admin to check if your id is valid, this will take a few minutes and after that click the link we've sent to your email to proceed.</p>
    ...
    <script src="assets/js/talent_verification.js"></script>
    <script>
