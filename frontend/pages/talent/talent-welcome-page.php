...
include("../../../backend/api/users/talent_vkey.php");
// session_start();
// // session_destroy();
...
<head>
    ...
    <!--css-->
    <link rel="stylesheet" type="text/css" href="assets/css/talent-welcome-page.css">
    </link>
...
<body>
    ...
    <div class="header" id="my-header">
        <div class="container">
            ...
            <div class="row">
                ...
                padding-top:80px;">
                    <center>
                        <img alt="" src="assets/images/boy-verified.gif" width="280" />
                    </center>
                    <p style="font-size: 16px;color:#333;margin-top:15px;text-align:center;">
    ...
    <script src="./assets/js/talent_welcome_page.js"></script>
    <script>
