window.onload = function() {
    ...
    function load_data(page, action) {
        ...
        if (action === "search") {
            ...
            $.ajax({
                url: "../../../../backend/api/jobs/search_my_saved_jobs.php",
                method: "POST",
                ...
                success: function(data) {
                    ...
                    if (data && data.length == 0) {
                        ...
                        <div class="col-2-2">
                            <p style="color:#555;font-size: 14px;"><span id="total-count-first">0</span> Saved Jobs found.</p>
                    ...
                    xhttp.open(
                        "POST",
                        "../../../../backend/api/jobs/search_saved_job_post_count.php"
                    );
                    ...
                    <div class="col-2-2">
                        <p style="color:#555;font-size: 14px;"><span id="total-count-first"> </span> Saved Jobs found.</p>
                        <label style="color:#555;font-size: 16px;
                        margin-right: 10px;
                        margin-top: 3px;" for="select-sort">Filter by: </label>
                        <select id="select-sort">
                                        ...
                                        <div id="job-page${results.id}" class="col-2 less-padding" style="
                                            ...
                                            <div style="width:100%;">
                                                ...
                                                <div class="div-3">
                                                    ...
                                                    <button class="apply-to-job-btn" style="margin-right: 10px;" id="atjb${results.user_id}/atjb${results.id}"> Apply</button>
                                                </div>
                        ...
                        document.getElementById("job-lists").insertAdjacentHTML(
                            ...
                            `
                                        <div class="col-2" id="page-btn">
                                            ...
                                            <div style="width: 70%;">
                                                <p style="color:#555;font-size: 14px;">${rowCount} out of <span id="total-count">${total_count_gago} </span> Saved Jobs</p>
                                            </div>
        ...
        $.ajax({
            url: "../../../../backend/api/jobs/my_saved_jobs.php",
            type: "POST",
            contentType: false,
            processData: false,
            ...
            success: function(data) {
                ...
                xhttp.open(
                    "GET",
                    "../../../../backend/api/jobs/saved_job_post_count.php"
                );
                xhttp.send();
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
    ...
    $(document).on('click', '.remove-btn', function() {
        ...
        xhttp.open(
            "DELETE",
            "../../../../backend/api/jobs/remove_saved_job.php"
        );
        xhttp.send(JSON.stringify({ job_post_id: user_id_profile.substr(2) }));
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                let results = JSON.parse(this.response);
                load_data(1);
