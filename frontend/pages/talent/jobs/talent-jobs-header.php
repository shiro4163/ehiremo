        ...
        <ul>
            <li>
                <div class="dropdown-jobs">
                    ...
                    display: block;" href="all-job-post.php">Browse Jobs</a>
                    <a style="color:#555;font-size: 14px;padding: 8px 10px;
                        text-decoration: none;
                    display: block;" href="saved-jobs.php">Saved Jobs</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="applied-jobs.php">Applied Jobs</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="my-jobs.php">My Jobs</a>
                    </div>
                </div>
            </li>
...
<div id="mySidenav" class="sidenav">
    ...
    padding-left: 32px;padding-right: 32px;">Jobs
        ...
        <div id="jobs-mobile-dropdown">
            <a href="all-job-post.php">Browse Jobs</a>
