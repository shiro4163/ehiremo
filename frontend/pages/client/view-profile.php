            ...
            <div class="row" style="border: none;margin-bottom: 20px;" id="f-row">
                ...
                <div class="profile-header-info header-80">
                    ...
                    <div id="action-area">
                        ...
                        <p style="font-size:16px;" id="view-portfolioo"><i class="fa fa-file-text" aria-hidden="true"></i> <a href="" target="_blank" id="view-portfolio" style="color: #1d4354;
        ...
        <div class="modal" style="text-align:center;">
            ...
            <div class="row" style="align-items:center;margin-top:20px;margin-bottom:20px;">
                ...
                <div style="" class="message2">
                    ...
                    <span style="font-size:20px;font-weight:500;" id="talent-name-profile2"></span> <span style="font-weight: 400;font-size:20px;" id="talent-role-profile2"></span>
