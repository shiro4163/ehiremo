        ...
        <ul>
            <li>
                <div class="dropdown-jobs">
                    ...
                    display: block;" href="post-job.php">Post a job</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="my-job-post.php">My Job Post</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="all-job-post.php">All Job Post</a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="dropdown-talent">
                    ...
                    <div class="dropdown-content-talent">
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="../talents/my-hires.php">My Hires</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="../talents/saved-talents.php">Saved Freelancers</a>
                        <a style="color:#555;font-size: 14px;padding: 8px 10px;
                    text-decoration: none;
                    display: block;" href="../talents/browse-talents.php">Browse Freelancers</a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="dropdown-profile">
                    ...
                    <div class="dropdown-content-profile">
                        <a title="" id="web-name" style="color:#555;font-size: 14px;padding: 8px 10px;
...
<div id="mySidenav" class="sidenav">
    ...
    padding-left: 32px;padding-right: 32px;">Jobs
        ...
        <div id="jobs-mobile-dropdown">
            ...
            <a href="my-job-post.php">My job post </a>
            <a href="all-job-post.php">All job post </a>
        </div>
        </p>
        <p style="font-size: 16px;margin-bottom: 16px;
    padding-left: 32px;padding-right: 32px;">Freelancers
        ...
        <div id="talent-mobile-dropdown">
            <a href="../talents/my-hires.php">My Hires</a>
            <a href="../talents/saved-talents.php">Saved Freelancers</a>
