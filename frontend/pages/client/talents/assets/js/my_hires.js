window.onload = function() {
    ...
    function load_data(page, action) {
        ...
        if (action === "search") {
            ...
            $.ajax({
                url: "../../../../backend/api/users/search_hired_freelancer.php",
                method: "POST",
                ...
                success: function(data) {
                    ...
                    if (data && data.length == 0) {
                        document.getElementById("profile-lists").insertAdjacentHTML(
                            ...
                            <div class="col-2 col-2-22">
                                <div class="col-2-2">
                                    <p style="font-weight:normal;color:#555;font-size: 14px;"><span id="total-count-first"> </span>0 Hired Freelancers found.</p>
                    ...
                    document.getElementById("profile-lists").insertAdjacentHTML(
                        ...
                        <div class="col-2 col-2-22">
                            ...
                            <div class="col-2-2">
                                <p style="font-weight:normal;color:#555;font-size: 14px;"><span id="total-count-first"> </span> Hired Freelancers found.</p>
                                <label style="color:#555;font-size: 16px;
                                margin-right: 10px;
                                margin-top: 3px;">Filter by: </label>
                                <select id="select-sort">
                    ...
                    load_search_data.pagee = 1;
                    var xhttp = new XMLHttpRequest();
                    xhttp.open(
                        "POST",
                        "../../../../backend/api/users/hired_freelancer_count_search.php"
                    );
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            let results = JSON.parse(this.response);
                            console.log(results)
                            $("#total-count").text(results);
                            $("#total-count-first").text(results);
                        }
                    }
                    ...
                    for (let row of data) {
                        ...
                        if (row.status === "done") {} else {
                            ...
                            justify-content: center;border-bottom: 1px solid rgb(214, 214, 214);">
                                ...
                                <button class="mark-done" id="msd${row.id}/${row.freelancer_id}"> Mark as done</button>
                        ...
                        `
                                    <div class="col-2" id="page-btn">
                                        ...
                                        <div style="width: 70%;">
                                            ...
                                            <span id="total-count"> </span> Hired Freelancers</p>
                                        </div>
        ...
        $.ajax({
            url: "../../../../backend/api/appointments/client_fetch_my_appointments.php",
            type: "POST",
            contentType: false,
            processData: false,
            ...
            success: function(data) {
                    ...
                    if (rowCount === 0) {
                        ...
                        document.getElementById("no-data").insertAdjacentHTML(
                            ...
                            padding-top: 30px;text-align: center;">
                                ...
                                <img alt="" src="assets/images/hired.png" width="80"/>
                ...
                xhttp.open(
                    "GET",
                    "../../../../backend/api/users/hired_freelancer_count.php"
                );
                xhttp.send();
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
    ...
    $(document).on('click', '#continue-search', function(e) {
        e.preventDefault();
    ...
    $(document).on('click', '.cancel-appointment', function(e) {
        ...
        $(document).on('click', '#decline-appoint', function(e) {
            ...
            xhttp.open(
                "PUT",
                "../../../../backend/api/appointments/cancel_appointment.php"
            );
    ...
    $(document).on('click', '#send-feedback', function(e) {
        ...
        /* get rating */
        var files = $('#upload-feedbacks').prop("files")
        ...
        $.map(files, function(val) {
            ...
            xhttp.open(
                "POST",
                "../../../../backend/api/feedback_photos_upload.php"
            );
            xhttp.send(formData);
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    xhttp.open(
                        "POST",
                        "../../../../backend/api/appointments/create_fb_appoint.php"
                    );
                    xhttp.send(JSON.stringify(fb_appoint));
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            let results = JSON.parse(this.response);
                        }
        ...
        xhttp.open(
            "PUT",
            "../../../../backend/api/appointments/markasdone_appointment.php"
        );
