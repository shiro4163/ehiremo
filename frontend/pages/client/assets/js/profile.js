window.onload = function() {
                                ...
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    justify-content: center;border-bottom: 1px solid rgb(214, 214, 214);">
                                        ...
                                        <div class="s-row">
                                            ...
                                            <div class="s-row-left">
                                                ...
                                                <div style="flex-basis: 70%;">
                                                    <p class="p-grey" style="color: #555;margin-top:20px;">Freelancer : <span class="view-profile" id="name${row.freelancer_id}">
                                        ...
                                        <div class="skills-button">
                                            <p class="p-grey" style="color: #555;margin-top:20px;">Client : <span class="view-profile" id="name${row.client_id}"> <span style="color: #14a800;text-decoration:underline;
    ...
    $(document).on('click', '.view-profile', function() {
        ...
        window.location.href = "view-profile.php?uid=" + user_id_profile.substring(4);
